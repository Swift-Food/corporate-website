...
export default function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      ...
      {/* Main Modal Content */}
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col lg:flex-row relative">
        {/* Close Button */}
        <button
          onClick={handleClose}
        ...
        {/* Left side - Image */}
        <div className="hidden lg:flex lg:w-1/2 relative bg-base-200 min-h-[600px]">
          <Image
        ...
        <div className="w-full lg:w-1/2 bg-base-100 relative overflow-hidden">
          <div className="h-full overflow-y-auto overflow-x-hidden px-8 py-8 max-h-[90vh] lg:max-h-[600px]">
